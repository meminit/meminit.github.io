        ...
        <>
            <div className="flex flex-row gap-10 not-md:flex-col">
                ...
                <div className="w-full flex flex-col gap-2">
                    <div className="w-full max-w-[670px]" id="captioned">
                        <div className="w-full bg-white font-bold p-2">
                            <p className="text-black text-center text-5xl break-words">{caption}</p>
                        </div>
                        <img src={image} className="w-full object-contain" alt="Upload Image Placeholder"></img>
                    </div>
